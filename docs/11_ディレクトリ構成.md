...
├── 03_詳細設計書.md          # 詳細設計仕様
├── 04_単体テスト仕様書.md    # ユニットテスト仕様
├── 05_運用設計書.md          # 運用・保守設計
├── 06_データ仕様書.md        # データベース・API仕様
├── 07_命名・規約.md          # コーディング規約
├── 08_ファインチューニング.md # モデル学習ガイド
├── 09_感情分析仕様書.md      # 感情分析の仕様
├── 10_モデル管理ガイド.md    # モデル管理運用
└── 11_ディレクトリ構成.md    # 本ドキュメント
```
...
├── test_sentiment.py         # 感情分析機能のテスト
├── test_repository.py        # データベース機能のテスト
├── test_analyzer.py          # 分析機能のテスト
├── test_summarizer.py        # 集計機能のテスト
├── test_truncate.py          # データ切り捨て機能のテスト
│
...
- データ仕様: [06\_データ仕様書.md](06_データ仕様書.md)
- コーディング規約: [07\_命名・規約.md](07_命名・規約.md)
- 運用ガイド: [05\_運用設計書.md](05_運用設計書.md)
